...
import app.core.presentation.designsystem.ArrowLeftIcon
...
@Preview
@Composable
private fun RunBuddyToolbarPreview() {
    RunBuddyTheme {
        RunBuddyToolbar(
            ...
            menuItems = listOf(DropDownItem(icon = AnalyticsIcon, title = "Analytics"))
        )
    }
}